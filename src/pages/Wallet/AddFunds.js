...
const Addfunds = () => {
  return (
    <div className="addFunds">
      <div className="addFunds_container">
        <h3 className="addFunds_title">Add Funds to Your Activation Wallet</h3>
        <form>
        ...
        <p className="notes">
          ...
          number of confirmations. It may take some time for confirmations.
